...
st.write("Take a look at which are the ideal days for this activity! (In the next 30 days)")
st.write("""
         ***
         """)
...
if (activity=='Sports 🏃'):
    ...
    future_df.sort_values(by=['predicted_precip', 'uvindex'], inplace=True, ascending=[False, False])
